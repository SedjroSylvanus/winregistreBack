...
public class SortiePaiement {
    ...
    public SortiePaiement(Double penalite, Double amende, Double redevance, Double droitSimple, Double manqueeGain, Double valeurTimbre, Double nombreTimbre, Double montantPaye) {
