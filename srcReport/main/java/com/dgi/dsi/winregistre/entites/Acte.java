...
//    private String depotSousMinite;
    ...
    public Acte(String numero, LocalDate dateActe, LocalDate dateEnregistrement, String reference, Double droitSimple, Double penalite, Double amende,
                ...
                String beneficiaireMarche, Double redevance, LocalDate dateDebutBail, LocalDate dateFinBail, String numeroTransfert, String nomParties, String nomContribuableSansIfu,
                String nomBeneficiaireSansIfu, String souceFinancementMarche, Double montantDu, Double montantPaye, Boolean contratRenouvelable, BordereauActe bordereauActe,
    ...
    public String toString() {
        return "Acte{" +
                ...
                ", nomContribuableSansIfu='" + nomContribuableSansIfu + '\'' +
