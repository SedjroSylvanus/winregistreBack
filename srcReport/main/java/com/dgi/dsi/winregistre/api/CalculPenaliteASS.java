...
//        LocalDate dateFormatter = LocalDate.parse(date, DateTimeFormatter.ofPattern("yyyy-MM-dd", Locale.ENGLISH));
        ...
        if(natureActe != null) {
            ...
            System.out.println("-------------natureActe non null----->"+natureActe);
            ...
            Double montantPenaliteAmendeNatureActeTypePenaliteAmende = natureActe.getTypePenaliteAmende().getMtPenaliteAmende()==null?0.0:natureActe.getTypePenaliteAmende().getMtPenaliteAmende();
            Double montantPenaliteEcheanceNatureActeTypePenaliteAmende = natureActe.getTypePenaliteAmende().getMtPenaliteEcheance()==null?0.0:natureActe.getTypePenaliteAmende().getMtPenaliteEcheance();
            ...
            String actenatureActeTypePenAmendeJourMoisAnnee = acte.getNatureActe().getTypePenaliteAmende().getJourMoisAnnee()==null? "T" :acte.getNatureActe().getTypePenaliteAmende().getJourMoisAnnee();

            System.out.println("------------- Fin natureActe non null----->"+natureActe);
