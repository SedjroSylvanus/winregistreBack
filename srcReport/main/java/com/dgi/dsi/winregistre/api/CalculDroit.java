...
//                    return sortiePaiement;
            ...
            Double minRedevanceNatureActe = NatureActe.getMinRedevance() == null ? 0.:NatureActe.getMinRedevance();
            redevance = montantActe * tauxRedevanceNatureActe;
            if (redevance < minRedevanceNatureActe) {
                redevance = minRedevanceNatureActe;
            }
